...
Shader "Hidden/Custom/SDF2D/Teapot"
{
	Properties{
		...
		_v0_beak_lower("Lower Beak v0", Vector) = (0,0,0,0)
		_v1_beak_lower("Lower Beak v1", Vector) = (0,0,0,0)
		_v2_beak_lower("Lower Beak v2", Vector) = (0,0,0,0)
		_v1_beak_upper("Upper Beak v1", Vector) = (0,0,0,0)
		_v2_beak_upper("Upper Beak v2", Vector) = (0,0,0,0)
		...
		SubShader
		{
			...
			Pass
			{
				...
				float4 _v0_beak_lower;
				float4 _v1_beak_lower;
				float4 _v2_beak_lower;

				float4 _v1_beak_upper;
				float4 _v2_beak_upper;
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					float beak_lower = sdBezier(center, _v0_beak_lower.xy, _v1_beak_lower.xy, _v2_beak_lower.xy);
					float beak_upper = sdBezier(center, _v2_beak_lower.xy, _v1_beak_upper.xy, _v2_beak_upper.xy);
					float beak = Union(beak_lower, beak_upper);
					beak -= _BeakSize;
